...
; RUN: %if spirv-tools %{ llc -O0 -mtriple=spirv32-unknown-unknown --spirv-ext=+SPV_INTEL_fp_max_error %s -o - -filetype=obj | spirv-val --max-struct-members 65535 %}
...
; CHECK: Capability FPMaxErrorINTEL
; CHECK: Extension "SPV_INTEL_fp_max_error"
; CHECK: ExtInstImport [[#OCLEXTID:]] "OpenCL.std"

; CHECK: Name [[#CalleeName:]] "callee"
; CHECK: Name [[#F3:]] "f3"
; CHECK: Decorate [[#F3]] FPMaxErrorDecorationINTEL 1075838976
; CHECK: Decorate [[#Callee:]] FPMaxErrorDecorationINTEL 1065353216

; CHECK: TypeFloat [[#FloatTy:]] 32
...
; CHECK: FunctionCall [[#FloatTy]] [[#Callee]] [[#CalleeName]]
